...
public class ModLootTableModifiers {
    ...
    private static Identifier buildAddInjectionRoute(Identifier id) {
        ...
        return new Identifier(MythicCharms.MOD_ID, "injections/modify/" + id.getNamespace() + "/" + id.getPath());

    }

    private static Identifier buildReplaceInjectionRoute(Identifier id) {

        return new Identifier(MythicCharms.MOD_ID, "injections/replace/" + id.getNamespace() + "/" + id.getPath());
