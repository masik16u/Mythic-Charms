...
public class CharmEmiRecipe implements EmiRecipe {
    ...
    public static final EmiTexture RESONANCE_RECIPE_TREE = new EmiTexture(new Identifier(MythicCharms.MOD_ID,
            "textures/gui/resonance_recipe_texture.png"), 0, 0, 16, 16, 16, 16, 16, 16);
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(new Identifier(MythicCharms.MOD_ID,
            "resonance_table"), MythicCharmsEmiPlugin.RESONANCE_TABLE, RESONANCE_RECIPE_TREE);
